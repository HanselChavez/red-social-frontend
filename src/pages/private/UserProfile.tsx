                ...
                <div className="px-6 pb-6">
                    <div className="flex items-end justify-between">
                        <img
                            src={avatar}
                            alt={fullName}
                            className="w-24 h-24 rounded-full object-cover border-4 border-background -mt-12 bg-background"
                        />

                        <button
                            onClick={handleSendFriendRequest}
                            disabled={sendingRequest || requestSent}
                            className={`font-semibold px-5 py-2 rounded-full transition flex items-center gap-2 ${requestSent
